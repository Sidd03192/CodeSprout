...
export default function Tables({ studentsData, onDelete, classroomData }) {
  ...
  return (
    <>
      <Input
        ...
        className='hover:border-2 border-emerald-500/70 border-3 border-emerald-500/70 dark rounded-xl mb-3 mt-8'
        value={searchTerm}
